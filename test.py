...
from src.main.client_fl import Client
from src.main.server_fl import Server
...
class FedAvg_Client(Client):
    ...
    def start(self, broker_host, port, **kwargs):
        self.connect(broker_host, port, keepalive=3600)
...
if __name__ == "__main__":
    server = FedAvg_Server(client_fl_id="server", server_config=server_config)
